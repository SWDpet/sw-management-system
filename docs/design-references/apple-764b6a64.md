...
| Key | Value |
| --- | --- |
| Source site | [https://www.apple.com/macbook-pro](https://www.apple.com/macbook-pro) |
| Refero page | [https://styles.refero.design/style/764b6a64-c233-4e0f-b8e1-bc01e2f8aa16](https://styles.refero.design/style/764b6a64-c233-4e0f-b8e1-bc01e2f8aa16) |
| Theme | dark |
| Industry | ecommerce |
...
| letterSpacing | -0.027, -0.022, -0.019, -0.016, -0.01, -0.006, -0.003 |
...
| lineHeight | 1.00, 1.05, 1.06, 1.07, 1.08, 1.10, 1.13, 1.14, 1.17, 1.19, 1.21, 1.38, 1.40 |
| letterSpacing | 0.004, 0.007, 0.009, 0.011, 0.012, -0.015, -0.009, -0.005, -0.003 |
| fontFeatureSettings | "numr" |
| substitute | Inter |
...
| --- | --- | --- | --- |
| Pitch Black Canvas | `#000000` | 0 | Base background for most pages, especially product showcases, creating an immersive, infinite dark space. |
| Deep Graphite Surface | `#161617` | 1 | Slightly elevated surface for navigation or subtle background shifts within dark sections, adding a hint of depth. |
| Space Gray Card | `#1d1d1f` | 2 | Primary surface for cards and distinct content blocks within dark layouts, providing clear separation from the canvas. |
| Storm Gray Overlay | `#333336` | 3 | Used for interactive elements like dropdowns, input backgrounds, or secondary navigation within dark contexts. |
| Cloud White Section | `#ffffff` | 4 | Distinct, high-contrast sections for detailed information, legal text, or content requiring extreme readability. |
...
---
_Source: https://styles.refero.design/style/764b6a64-c233-4e0f-b8e1-bc01e2f8aa16_
