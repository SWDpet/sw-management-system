...
| Key | Value |
| --- | --- |
| Source site | [https://elevenlabs.io](https://elevenlabs.io) |
| Refero page | [https://styles.refero.design/style/031056ff-7af1-46db-8daa-115f731c5d26](https://styles.refero.design/style/031056ff-7af1-46db-8daa-115f731c5d26) |
| Theme | light |
| Industry | ai |
...
| lineHeight | 1.08–1.17 |
| letterSpacing | -0.64px at 32px, -0.72px at 36px, -0.96px at 48px |
...
| lineHeight | 1.0–2.06 |
| letterSpacing | 0.1px–0.2px across all sizes |
...
| --- | --- | --- | --- |
| Page Ground | `#fdfcfc` | 0 | Base page background — all page-level content sits here |
| Powder Surface | `#f5f3f1` | 1 | Section highlights, active row states, nav hover backgrounds |
| Card White | `#ffffff` | 2 | Interactive demo cards and form inputs that need to pop off the eggshell ground |
| Obsidian | `#000000` | 3 | Primary CTA fill, logo mark, full-bleed dark sections |
...
---
_Source: https://styles.refero.design/style/031056ff-7af1-46db-8daa-115f731c5d26_
