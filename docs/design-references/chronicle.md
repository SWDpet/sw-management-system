...
| Key | Value |
| --- | --- |
| Source site | [https://chroniclehq.com](https://chroniclehq.com) |
| Refero page | [https://styles.refero.design/style/1c60b014-473b-443b-b0f5-220612feebb7](https://styles.refero.design/style/1c60b014-473b-443b-b0f5-220612feebb7) |
| Theme | light |
| Industry | saas |
...
| lineHeight | 1.00–1.40 (1.00 at display, 1.05 at large headings, 1.10–1.20 at subheadings, 1.40 at body) |
| letterSpacing | -0.030em at 54px and 48px; -0.023em at 32px; -0.020em at 20px; 0 at 16px and below |
...
| --- | --- | --- | --- |
| Canvas | `#ffffff` | 1 | Primary page background for hero and main content sections |
| Tinted Surface | `#f3f3f3` | 2 | Alternating section backgrounds — testimonials, feature band, footer area |
| Card Surface | `#ffffff` | 3 | White cards elevated above gray sections with 8px radius and soft shadow |
| Border Plane | `#e2e2e2` | 4 | Image frames, card outlines, input borders — structural hairlines |
...
---
_Source: https://styles.refero.design/style/1c60b014-473b-443b-b0f5-220612feebb7_
