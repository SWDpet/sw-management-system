...
| Key | Value |
| --- | --- |
| Source site | [https://warp.dev/terminal](https://warp.dev/terminal) |
| Refero page | [https://styles.refero.design/style/720c9806-2d70-4dd1-9a19-12efd71fc742](https://styles.refero.design/style/720c9806-2d70-4dd1-9a19-12efd71fc742) |
| Theme | dark |
| Industry | devtools |
...
| lineHeight | 0.90–1.56 (tight at display: 0.90–1.00; relaxed at body: 1.40–1.56) |
| letterSpacing | -0.04em at 64px, -0.03em at 56px, -0.02em at 32-48px, -0.01em at 20-24px, 0.01em at 12-14px (slight open tracking for small labels) |
...
| letterSpacing | -0.02em at 16px, -0.014em at 16px, -0.012em at 14px |
| fontFeatureSettings | "blwf", "cv03", "cv04", "cv09", "cv11" |
...
| weight | 400, 600 |
| sizes | 12px, 14px, 16px, 18px, 20px, 24px, 32px, 40px, 48px, 56px, 64px |
| lineHeight | 0.9, 1, 1.1, 1.12, 1.15, 1.19, 1.2, 1.35, 1.38, 1.4, 1.5, 1.56 |
| letterSpacing | -0.04, -0.03, -0.02, -0.01, 0.01, 0.1, 0.2 |
| fontFeatureSettings | "blwf", "cv03", "cv04", "cv09", "cv11" |
...
| --- | --- | --- | --- |
| Deep Base | `#090909` | 0 | Absolute floor — nav overlay backgrounds, announcement bar |
| Canvas | `#121212` | 1 | Primary page background used across most sections |
| Elevated Card | `#1e1e1d` | 2 | Footer background, slightly raised content regions |
| Raised Surface | `#353534` | 3 | Card backgrounds, pill button fills, dropdown containers |
| Interactive Surface | `#40403f` | 4 | Hover states, focused overlay containers |
...
---
_Source: https://styles.refero.design/style/720c9806-2d70-4dd1-9a19-12efd71fc742_
