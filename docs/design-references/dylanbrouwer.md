...
| Key | Value |
| --- | --- |
| Source site | [https://www.dylanbrouwer.design](https://www.dylanbrouwer.design) |
| Refero page | [https://styles.refero.design/style/b1e82907-d1cf-46cd-8ae7-3561c5b15fd0](https://styles.refero.design/style/b1e82907-d1cf-46cd-8ae7-3561c5b15fd0) |
| Theme | light |
| Industry | design |
...
| lineHeight | 1.00, 1.10, 1.25, 1.30 |
| letterSpacing | -0.0300em (at 60px), -0.0200em (at 54px), -0.0100em (at 12-36px) |
...
| letterSpacing | -0.0200em (at 14px), -0.0100em (at 12px) |
...
| lineHeight | 0.74, 1.00, 1.30 |
| letterSpacing | -0.0200em (at 288px), -0.0100em (at 274px), -0.0050em (at 96px) |
| substitute | Arial, Helvetica, sans-serif |
...
| --- | --- | --- | --- |
| Canvas White | `#ffffff` | 0 | Primary page background, creating a bright, spacious default context. |
| Silver Dust | `#f1f1f1` | 1 | Secondary background for alternating content sections, providing a subtle visual break. |
| Card White Subtle | `#ffffff` | 2 | Semi-transparent card surfaces using `rgba(255, 255, 255, 0.5)`, creating a frosted, layered effect. |
| Deep Space | `#161616` | 3 | Used for sections or elements requiring maximum visual weight and contrast, often as a dark background for strong headlines. |
...
---
_Source: https://styles.refero.design/style/b1e82907-d1cf-46cd-8ae7-3561c5b15fd0_
