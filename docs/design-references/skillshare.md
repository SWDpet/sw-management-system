...
| Key | Value |
| --- | --- |
| Source site | [https://skillshare.com](https://skillshare.com) |
| Refero page | [https://styles.refero.design/style/162e9ba9-7487-4b57-aee8-0bbeadcc586d](https://styles.refero.design/style/162e9ba9-7487-4b57-aee8-0bbeadcc586d) |
| Theme | mixed |
| Industry | media |
...
| lineHeight | 0.90–1.55 (tight 0.90–0.96 at display sizes 36px+, 1.20–1.50 at body sizes) |
| letterSpacing | 0.1em on uppercase labels (caps tracking for ALL-CAPS metadata like MEMBERS, CLASSES, TEACHERS) |
...
| --- | --- | --- | --- |
| Pure Black | `#000000` | 0 | Dark section backgrounds, hero right panel, feature sections |
| Charcoal Lift | `#232424` | 1 | Stat cards and metric tiles floating on pure black sections |
| White Page | `#ffffff` | 2 | Light section backgrounds, registration panel, card surfaces |
| Navigation Bar | `#ffffff` | 3 | Sticky nav — same white as page background, separated by content not chrome |
...
---
_Source: https://styles.refero.design/style/162e9ba9-7487-4b57-aee8-0bbeadcc586d_
