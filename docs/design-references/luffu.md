...
| Key | Value |
| --- | --- |
| Source site | [https://luffu.com](https://luffu.com) |
| Refero page | [https://styles.refero.design/style/3da7b444-ded8-406b-90b7-96851604b92b](https://styles.refero.design/style/3da7b444-ded8-406b-90b7-96851604b92b) |
| Theme | light |
| Industry | ai |
...
| lineHeight | 1.0–1.2 |
| letterSpacing | -0.35px at 14px, -0.32px at 16px, -0.32px at 20px |
...
| lineHeight | 1.0 |
| letterSpacing | -3.2px at 64px, -2.02px at 48px, -1.24px at 40px |
...
| --- | --- | --- | --- |
| Page Ground | `#f5f5ee` | 0 | Default section background — the warm cream anchor of the entire system |
| Section Lift | `#e4e7da` | 1 | Subtle section differentiation without color shift |
| Card Surface | `#d7d7cb` | 2 | Feature card backgrounds and UI mock containers |
| Dark Anchor | `#192830` | 3 | Primary button fill and footer background — the only true dark surfaces |
...
---
_Source: https://styles.refero.design/style/3da7b444-ded8-406b-90b7-96851604b92b_
