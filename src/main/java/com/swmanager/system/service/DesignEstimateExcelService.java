...
import static com.swmanager.system.service.ExcelStyleSupport.setCellValue;
...
/**
 * 설계내역서(견적) Excel 생성 — ExcelExportService 에서 분리(excel-service-split §6-5 B).
 *
 * design_estimate 섹션을 받아 TYPE_A/B/C/SW/D 양식 xlsx 를 만든다. 공용 셀 헬퍼는
 * {@link ExcelStyleSupport}(static import), 절사정책 static 은 {@link ExcelExportService}.
...
public class DesignEstimateExcelService {
    ...
    // setStringDirect/setNumericDirect 는 ExcelStyleSupport 로 이동(§6-5 A, static import).
