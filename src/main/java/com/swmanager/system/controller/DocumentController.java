...
public class DocumentController {
    ...
    // [S4 Phase 3] pjtTarget/pjtManpowerPlan/pjtSchedule Repository → DocumentPlanController 로 이동.
    ...
    // [S4 Phase 2] 착수계/기성/준공 일괄 작성(batch 4 엔드포인트 + buildBatchLetterData)은
    // DocumentBatchController 로 이동(refactor-document-controller-split-phase2).
    ...
    // [S4 Phase 3] 사업수행계획서(plan, GET/POST /api/plan/{projId} + asInt/asBool + pjt* 전용 repo 3)는
    // DocumentPlanController 로 이동(refactor-document-controller-split-phase3).
