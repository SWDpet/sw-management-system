...
public class User implements Serializable { // [2] 필수: Serializable 구현 추가
    ...
    // [ops-fault-support M1] org_unit_id(FK) 를 조직 SoT 로 사용. 아래 문자열 3종은 deprecated(표시용 동결, 신규 쓰기 금지)
    private String orgNm;
    private String deptNm;
    private String teamNm;
    private String tel;

    // [ops-fault-support M1] 조직도 단위 FK (tb_org_unit). 엔지니어 풀 = org_unit=SW지원팀
    ...
    // ✨ LSA(라이선스 발급 대장) 권한 필드 추가 — License4J/GeoNURIS 와 독립
    @Column(name = "auth_lsa")
    private String authLsa;
    ...
    public void prePersist() {
        ...
        // ✨ LSA 권한 기본값 설정
        if (this.authLsa == null) this.authLsa = "NONE";
        // ✨ 견적서 권한 기본값 설정
